      ...
      <section className="banner_wrap">
        <div className="banner_content">
            ...
            <div class="btn_area pc">
              <a href="#" className={BtnAreaCss.blueBtn}>웹브라우저에서 열기</a>
              <a href="#" className={`${BtnAreaCss.blueBtn} ${BtnAreaCss.pcDownload}`}><span>PC 버전 다운로드</span></a>
              <a href="#" className={`${BtnAreaCss.grayBtn} ${BtnAreaCss.playStore}`}><span>Google Play</span></a>
              <a href="#" className={`${BtnAreaCss.grayBtn} ${BtnAreaCss.appStore}`}><span>App Store</span></a>
            </div>
            <div class="btn_area mo">
              <a href="#" className={`${BtnAreaCss.blueBtn} ${BtnAreaCss.playStore}`}><span>Google Play</span></a>
              <a href="#" className={`${BtnAreaCss.blueBtn} ${BtnAreaCss.appStore}`}><span>App Store</span></a>
            </div>
          </div>
      </section>
        ...
        <div className="footer_Wrap">
          ...
          <div className="footer_content">
            <div className="company">
              <h4>고객센터</h4>
              <a href="tel:1644-5510">1644 - 5510 (2번)</a>
